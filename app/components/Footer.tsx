        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://wa.me/message/QXZRVT3NLXWRP1" target="_blank" rel="noopener noreferrer" className="w-13 h-13 bg-gray-800 hover:bg-green-500 rounded-lg flex items-center justify-center transition-colors" aria-label="WhatsApp">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor"
                        viewBox="0 0 448 512"
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+234 812 209 9927" className="hover:text-blue-400 transition-colors text-lg">+234 812 209 9927</a>
              </li>
              <li className="flex items-center">
